...
const WIDGET_LIST = [
  ...
  { key: 'repurchase_due',     label: '재구매 주기 임박',      desc: '평균 주기+2일 초과 고객' },
  { key: 'co_purchase',        label: '세트·공동구매',         desc: '기준 품목 동반 구매·lift' },
  { key: 'procurement_gap',    label: '발주 vs 예측',          desc: '내일 예측·실적 대비 발주 갭' },
  { key: 'rfm_pipeline',       label: 'RFM 고객 등급',         desc: 'VIP·단골·이탈위험 등급 분포' },
  { key: 'lost_buyers',        label: '품목별 이탈 고객',      desc: '재구매 고객 중 품목별 미방문' },
