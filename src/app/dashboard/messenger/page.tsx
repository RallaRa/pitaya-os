...
import {
  MessageCircle, Send, Search, Loader2,
...
export default function MessengerPage() {
  ...
  const loadUsers = async () => {
    ...
    try {
      const res = await fetch(
        `/api/users?storeId=${currentStore.storeId}`
      );
      const data = await res.json();
      // 자신 제외
      setUsers((data.users || []).filter(
        (u: UserProfile) => u.uid !== user.uid
      ));
  ...
  // 개발용 시드 데이터 주입 (클라이언트에서 직접 Firestore 쓰기)
      ...
      `}>
        ...
        <div className="px-4 py-3 border-b border-slate-700">
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mb-3 p-2.5 bg-amber-950/40 border
              border-amber-700/50 rounded-lg">
              ...
              <button
                ...
                className="w-full text-xs bg-amber-600 hover:bg-amber-500
                  disabled:bg-slate-700 text-white py-1.5 rounded-md
                  transition-colors font-medium"
              >
                {isSeedLoading ? '주입 중...' : '시드 데이터 주입'}
              </button>
              {seedResult && (
                <pre className="mt-1.5 text-amber-300 text-xs
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-800 border border-slate-700
                rounded-xl pl-9 pr-4 py-2 text-slate-100 text-sm
        ...
        {showUserList && (
          <div className="border-b border-slate-700
            max-h-52 overflow-y-auto bg-slate-800/50">
        ...
        <div className="flex-1 overflow-y-auto">
          {rooms.length === 0 ? (
            <div className="flex flex-col items-center
              justify-center h-full text-center p-6">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    <Circle className="absolute bottom-0 right-0
                      w-3 h-3 text-emerald-400 fill-emerald-400" />
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {unread > 0 && (
                        <span className="bg-teal-500 text-white
                          text-xs rounded-full w-5 h-5 flex items-center
                          justify-center flex-shrink-0 ml-2 font-bold">
                          {unread}
                        </span>
                      )}
                    </div>
            ...
            <div className="bg-slate-900 border-b
              ...
              <div className="w-9 h-9 rounded-full bg-slate-600
                ...
                <span className="text-white font-bold text-sm">
                  {getPartner(currentRoom).name.slice(0, 1)}
                </span>
              </div>
              <div>
                <p className="text-white font-bold text-sm">
                  {getPartner(currentRoom).name}
                </p>
                    ...
                    <div className={`flex gap-2 max-w-[70%]
                      ...
                      {!isMine && (
                        <div className="w-8 h-8 rounded-full
                          bg-slate-600 flex items-center
                          justify-center flex-shrink-0 self-end">
                      ...
                      <div className={`flex flex-col
                        ...
                        <div className="flex items-end gap-1.5">
                          ...
                          <div className={`px-3 py-2 rounded-2xl
                            text-sm max-w-full break-words
                            ${isMine
            ...
            <div className="bg-slate-900 border-t
              ...
              <div className="flex items-end gap-2">
                <textarea
                  ...
                  rows={1}
                  className="flex-1 bg-slate-800 border
                    border-slate-700 rounded-xl px-4 py-2.5
                ...
                <button
                  ...
                  disabled={!input.trim()}
                  className="bg-teal-600 hover:bg-teal-500
                    disabled:bg-slate-700 text-white p-2.5
