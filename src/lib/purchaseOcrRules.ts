...
- 거래량(kg)·중량은 소수점 둘째 자리까지 정확히 (예: 21.80, 36.00).
...
export const ANALYZE_MULTI_SYSTEM = appendStoreBusinessContext(`당신은 한국 정육점·식자재 매입 문서(거래명세서, 세금계산서, 매입전표, 영수증) 전문 OCR·분석 AI입니다.
