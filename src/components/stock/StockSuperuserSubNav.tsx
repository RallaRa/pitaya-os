...
import { LayoutGrid, Sparkles, LineChart, ScrollText, Settings } from 'lucide-react';
import {
...
export default function StockSuperuserSubNav() {
  ...
  return (
    <nav className="flex items-center gap-1 px-2 sm:px-3 py-2 border-b border-slate-800 bg-slate-950/90 overflow-x-auto">
