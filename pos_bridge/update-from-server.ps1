...
$files = @('bridge.js', 'package.json', 'sync-customers.bat', 'run-realtime.bat', 'run-realtime-hidden.vbs', 'install-realtime-task.bat', 'find-ukey2-key.ps1', 'FIND-KEY.bat', 'dll-strings.ps1', 'export-en-ukey2.bat', 'remote-from-pitaya.ps1', 'probe-pos-member-screen.ps1', 'probe-pos-member-ocr.ps1', 'sync-member-manual.ps1', 'RUN-OCR-TEST.bat', 'scrape-pos-member-ui.ps1', 'merge-member-phones.ps1', 'pos-member-watcher.js', 'run-member-watcher.bat', 'run-member-watcher-loop.bat', 'run-member-watcher-hidden.vbs', 'install-member-watcher.ps1', 'install-member-watcher.bat')
