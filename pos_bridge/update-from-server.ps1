...
$files = @('bridge.js', 'package.json', 'sync-customers.bat', 'run-realtime.bat', 'run-realtime-hidden.vbs', 'install-realtime-task.bat', 'find-ukey2-key.ps1', 'FIND-KEY.bat', 'dll-strings.ps1', 'export-en-ukey2.bat', 'remote-from-pitaya.ps1', 'probe-pos-member-screen.ps1', 'pos-member-watcher.js', 'run-member-watcher.bat', 'install-member-watcher.ps1')
